package com.sky.backend.ms.user.external.project.exception.adivice;


import com.sky.backend.ms.user.external.project.domain.dto.response.ErrorResponseDto;
import com.sky.backend.ms.user.external.project.exception.ForbiddenException;
